...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Details Of Marriage"))
        self.marriageTypeLabel.setText(_translate("MainWindow", "Marriage Type"))
        self.marriageDateLabel.setText(_translate("MainWindow", "Marriage Date"))
        self.locationOfMarriageLabel.setText(_translate("MainWindow", "Location Of marriage"))
        ...
        self.villageLabel.setText(_translate("MainWindow", "village"))
        self.houseNoLabel.setText(_translate("MainWindow", "House No"))
        self.locationIfMarriageAbroadLabel.setText(_translate("MainWindow", "Location if Marriage Abroad"))
        self.Label_2.setText(_translate("MainWindow", ".."))
        self.label_5.setText(_translate("MainWindow", "Bride"))
        self.label_2.setText(_translate("MainWindow", "Bridegroom"))
        self.nameLabel_2.setText(_translate("MainWindow", "Name"))
        self.lastnameLabel.setText(_translate("MainWindow", "Lastname"))
        self.fullNameLabel_2.setText(_translate("MainWindow", "Full name"))
        self.dateOfBirthLabel.setText(_translate("MainWindow", "Date of Birth"))
        self.casteLabel_2.setText(_translate("MainWindow", "caste"))
        self.qualificationLabel_2.setText(_translate("MainWindow", "Qualification"))
        self.occupationLabel_2.setText(_translate("MainWindow", "Occupation"))
        self.preMaritalStatusLabel_2.setText(_translate("MainWindow", "Pre-marital status"))
        self.permanentAdressLabel_2.setText(_translate("MainWindow", "Permanent Adress"))
        self.districtLabel_3.setText(_translate("MainWindow", "District"))
        self.municipalityLabel_3.setText(_translate("MainWindow", "Municipality"))
        self.wardNoLabel_3.setText(_translate("MainWindow", "Ward No"))
        ...
        self.houseNoLabel_3.setText(_translate("MainWindow", "House No"))
        self.birthCountryLabel_2.setText(_translate("MainWindow", "Birth Country"))
        self.countryWithCitizenshipLabel_2.setText(_translate("MainWindow", "Country With citizenship"))
        self.citizenshipNoLabel_2.setText(_translate("MainWindow", "Citizenship No"))
        self.issueDateLabel_2.setText(_translate("MainWindow", "Issue Date"))
        self.issueDistrictLabel_2.setText(_translate("MainWindow", "Issue District"))
        self.passportNoIfForeignLabel_2.setText(_translate("MainWindow", "Passport No(if foreign)"))
        self.countryIfForeignLabel_2.setText(_translate("MainWindow", "country(if foreign)"))
        self.adressIfForeignLabel_2.setText(_translate("MainWindow", "Adress(if foreign)"))
        self.grandfatherNameLabel_2.setText(_translate("MainWindow", "Grandfather Name"))
        self.fatherNameLabel_2.setText(_translate("MainWindow", "Father Name"))
        self.motherNameLabel_2.setText(_translate("MainWindow", "Mother Name"))
