...
class Ui_BirthForm(object):
    def setupUi(self, BirthForm):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 843, 1282))
        ...
        self.placeOfBirthComboBox.addItem("")
        self.placeOfBirthComboBox.addItem("")
        self.placeOfBirthComboBox.addItem("")
        ...
        self.birthTypeComboBox.addItem("")
        self.birthTypeComboBox.addItem("")
        self.birthTypeComboBox.addItem("")
    ...
    def retranslateUi(self, BirthForm):
        ...
        self.placeOfBirthComboBox.setItemText(0, _translate("BirthForm", "Hospital"))
        self.placeOfBirthComboBox.setItemText(1, _translate("BirthForm", "Health Post"))
        self.placeOfBirthComboBox.setItemText(2, _translate("BirthForm", "Other"))
        self.genderLabel.setText(_translate("BirthForm", "Gender"))
        self.genderComboBox.setItemText(0, _translate("BirthForm", "Male"))
        self.genderComboBox.setItemText(1, _translate("BirthForm", "female"))
        self.genderComboBox.setItemText(2, _translate("BirthForm", "Other"))
        self.casteLabel.setText(_translate("BirthForm", "Caste"))
        self.birthTypeLabel.setText(_translate("BirthForm", "Birth Type"))
        self.birthTypeComboBox.setItemText(0, _translate("BirthForm", "single"))
        self.birthTypeComboBox.setItemText(1, _translate("BirthForm", "Twins"))
        self.birthTypeComboBox.setItemText(2, _translate("BirthForm", "Three or more"))
...
class ActualWork():
    ...
    def getallvalues(self):
        ...
        year,month,day=date.getDate()
        self.marriage_in_ad1=datetime.date(year,month,day)
        date=QDate(self.ui.dateEdit.date())
        year,month,day=date.getDate()
        marriage_in_ad2=datetime.date(year,month,day)
...
if __name__ == "__main__":
    ...
    aw=ActualWork()
    '''
    BirthForm = QtWidgets.QMainWindow()
    ui = Ui_BirthForm()
    ui.setupUi(BirthForm)
    BirthForm.show()
    '''
    sys.exit(app.exec_())
